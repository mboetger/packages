...
class PlatformCameraDescription {
  ...
  static PlatformCameraDescription decode(Object result) {
    ...
    return PlatformCameraDescription(
      ...
      lensType: result[3]! as PlatformCameraLensType,
    );
  }
...
class CameraApi {
  ...
  Future<void> setJpegImageQuality(int quality) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.camera_android.CameraApi.setJpegImageQuality$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
