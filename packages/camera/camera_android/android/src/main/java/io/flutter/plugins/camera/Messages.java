...
public class Messages {
  ...
  public interface CameraApi {
    ...
    void startVideoRecording(@NonNull Boolean enableStream, @NonNull VoidResult result);

    /**
     * Ends video recording on the camera with the given ID and returns the path to the resulting
     * file.
     */
    void stopVideoRecording(@NonNull Result<String> result);
        ...
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ...
                api.startVideoRecording(enableStreamArg, resultCallback);
              });
        } else {
          channel.setMessageHandler(null);
        }
