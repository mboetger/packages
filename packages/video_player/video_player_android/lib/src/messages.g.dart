...
class CreationOptions {
  ...
  static CreationOptions decode(Object result) {
    ...
    return CreationOptions(
      ...
      flagDetectAccessUnits: result[5]! as bool,
      flagAllowNonIdrKeyframes: result[6]! as bool,
    );
  }
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(uri, other.uri) && _deepEquals(formatHint, other.formatHint) && _deepEquals(httpHeaders, other.httpHeaders) && _deepEquals(userAgent, other.userAgent) && _deepEquals(backBufferDurationMs, other.backBufferDurationMs) && _deepEquals(flagDetectAccessUnits, other.flagDetectAccessUnits) && _deepEquals(flagAllowNonIdrKeyframes, other.flagAllowNonIdrKeyframes);
  }
