...
data class CreationOptions (
  ...
  val flagDetectAccessUnits: Boolean,
  val flagAllowNonIdrKeyframes: Boolean
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): CreationOptions {
      ...
      val flagDetectAccessUnits = pigeonVar_list[5] as Boolean
      val flagAllowNonIdrKeyframes = pigeonVar_list[6] as Boolean
      return CreationOptions(uri, formatHint, httpHeaders, userAgent, backBufferDurationMs, flagDetectAccessUnits, flagAllowNonIdrKeyframes)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    return MessagesPigeonUtils.deepEquals(this.uri, other.uri) && MessagesPigeonUtils.deepEquals(this.formatHint, other.formatHint) && MessagesPigeonUtils.deepEquals(this.httpHeaders, other.httpHeaders) && MessagesPigeonUtils.deepEquals(this.userAgent, other.userAgent) && MessagesPigeonUtils.deepEquals(this.backBufferDurationMs, other.backBufferDurationMs) && MessagesPigeonUtils.deepEquals(this.flagDetectAccessUnits, other.flagDetectAccessUnits) && MessagesPigeonUtils.deepEquals(this.flagAllowNonIdrKeyframes, other.flagAllowNonIdrKeyframes)
  }
  ...
  override fun hashCode(): Int {
    ...
    result = 31 * result + MessagesPigeonUtils.deepHash(this.flagDetectAccessUnits)
    result = 31 * result + MessagesPigeonUtils.deepHash(this.flagAllowNonIdrKeyframes)
    return result
  }
}
